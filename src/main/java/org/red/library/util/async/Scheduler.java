package org.red.library.util.async;
...
public class Scheduler {
    ...
    public static void repeatDelayScheduler(final RunnableEx task, int startDelayTick, int delayTick, int repeat) {
        ...
        task.setTaskId(Bukkit.getScheduler().scheduleSyncRepeatingTask(RedKillerLibrary.getPlugin(), task, startDelayTick, delayTick));
    }
