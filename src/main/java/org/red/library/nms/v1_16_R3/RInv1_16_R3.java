...
public class RInv1_16_R3 extends CraftInventoryCustom implements RInventory {
    ...
    public RInv1_16_R3(InventoryHolder owner, InventoryType type) {
        super(owner, type);
    }

    public RInv1_16_R3(InventoryHolder owner, InventoryType type, String title) {
        super(owner, type, title);
    }

    public RInv1_16_R3(InventoryHolder owner, int size) {
        super(owner, size);
    }

    public RInv1_16_R3(InventoryHolder owner, int size, String title) {
