package org.red.library.nms.v1_18_R2;
...
public class RInv1_18_R2 extends CraftInventoryCustom implements RInventory {
    private final Map<Integer, Button> buttonMap = new HashMap<>();
    private final CustomInventory customInventory;
    public RInv1_18_R2(InventoryHolder owner, InventoryType type, CustomInventory customInventory) {
        super(owner, type);
        this.customInventory = customInventory;
    }

    public RInv1_18_R2(InventoryHolder owner, InventoryType type, String title, CustomInventory customInventory) {
        super(owner, type, title);
        this.customInventory = customInventory;
    }

    public RInv1_18_R2(InventoryHolder owner, int size, CustomInventory customInventory) {
        super(owner, size);
        this.customInventory = customInventory;
    }

    public RInv1_18_R2(InventoryHolder owner, int size, String title, CustomInventory customInventory) {
